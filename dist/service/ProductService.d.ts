...
export declare class ProductService extends BaseService {
     ...
     */
    getProduct(variables: ProductQueryVariables): Promise<Product>;
    /**
     ...
     */
    getProducts(variables: ProductsQueryVariables): Promise<ProductsResponse>;
    /**
     ...
     */
    importProductsCsv(input: ProductCsvInput): Promise<CsvImportResponse>;
    /**
     Adds surcharges to a product
     * @param input Surcharges input data
     * @returns Promise<boolean> Success status
     */
    addSurchargesToProduct(input: AddSurchargesToProductInput): Promise<boolean>;
    /**
     Fetches surcharges for a product
     * @param productId Product ID
     * @returns Promise<SurchargesResponse> The surcharges response
     */
    getProductSurcharges(productId: number): Promise<SurchargesResponse>;
    /**
     ...
     */
    getAttributesByProductId(productId: number, input: AttributeSearchInput): Promise<AttributeResponse>;
    /**
     ...
     */
    getAttributeResultByProductId(productId: number, input: AttributeResultSearchInput): Promise<AttributeResultResponse>;
    /**
