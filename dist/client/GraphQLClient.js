...
exports.client = exports.GraphQLClient = void 0;
...
class GraphQLClient {
     ...
     */
    registerFragment(name, definition) {
     ...
     */
    collectRequiredFragments(query, visited = new Set()) {
...
GraphQLClient.ORDER_EDITOR_MUTATIONS = new Set([
    'orderSetStatus',
    'passwordResetLink',
